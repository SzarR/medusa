  ...
  if(include_ABD == TRUE) {
    ...
    df <- df %>%
      mutate(
        Highest_Degree =
          case_when(
            #str_detect(Degree, "ABD") | The ABD has been turned off.
            str_detect(Degree, "grad program") | str_detect(Degree, "(?i)PhD") | str_detect(Degree, "DBA") |
            str_detect(Degree, "DM") | str_detect(Degree, "EdD") | str_detect(Degree, "EdS") | str_detect(Degree, "DrPH") |
            str_detect(Degree, "Dr.") | str_detect(Degree, "PsyD") | str_detect(Degree, "JD") | str_detect(Degree, "JD/MBA") ~ "Doctorate",
